...
// ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeFirstFuture an abstraction for monitoring and
// retrieving the results of a long-running operation.
type ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeFirstFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(ResourceTypeRegistrationsClient) (ResourceTypeRegistration, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeFirstFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeFirstFuture.Result.
func (future *ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeFirstFuture) result(client ResourceTypeRegistrationsClient) (rtr ResourceTypeRegistration, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "providerhub.ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeFirstFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		rtr.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("providerhub.ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeFirstFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if rtr.Response.Response, err = future.GetResult(sender); err == nil && rtr.Response.Response.StatusCode != http.StatusNoContent {
		rtr, err = client.CreateOrUpdateNestedResourceTypeFirstResponder(rtr.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "providerhub.ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeFirstFuture", "Result", rtr.Response.Response, "Failure responding to request")
		}
	}
	return
}

// ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeSecondFuture an abstraction for monitoring and
// retrieving the results of a long-running operation.
type ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeSecondFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(ResourceTypeRegistrationsClient) (ResourceTypeRegistration, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeSecondFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeSecondFuture.Result.
func (future *ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeSecondFuture) result(client ResourceTypeRegistrationsClient) (rtr ResourceTypeRegistration, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "providerhub.ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeSecondFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		rtr.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("providerhub.ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeSecondFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if rtr.Response.Response, err = future.GetResult(sender); err == nil && rtr.Response.Response.StatusCode != http.StatusNoContent {
		rtr, err = client.CreateOrUpdateNestedResourceTypeSecondResponder(rtr.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "providerhub.ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeSecondFuture", "Result", rtr.Response.Response, "Failure responding to request")
		}
	}
	return
}

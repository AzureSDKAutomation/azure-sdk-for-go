...
type ResourceTypeRegistrationsClientAPI interface {
	...
	CreateOrUpdateNestedResourceTypeFirst(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string, properties providerhub.ResourceTypeRegistration) (result providerhub.ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeFirstFuture, err error)
	CreateOrUpdateNestedResourceTypeSecond(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string, nestedResourceTypeSecond string, properties providerhub.ResourceTypeRegistration) (result providerhub.ResourceTypeRegistrationsCreateOrUpdateNestedResourceTypeSecondFuture, err error)
	Delete(ctx context.Context, providerNamespace string, resourceType string) (result autorest.Response, err error)
	DeleteNestedResourceTypeFirst(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string) (result autorest.Response, err error)
	DeleteNestedResourceTypeSecond(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string, nestedResourceTypeSecond string) (result autorest.Response, err error)
	...
	GetNestedResourceTypeFirst(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string) (result providerhub.ResourceTypeRegistration, err error)
	GetNestedResourceTypeSecond(ctx context.Context, providerNamespace string, resourceType string, nestedResourceTypeFirst string, nestedResourceTypeSecond string) (result providerhub.ResourceTypeRegistration, err error)

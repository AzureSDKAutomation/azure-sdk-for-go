...
// AmlComputeNodesResult result of AmlCompute Nodes
type AmlComputeNodesResult struct {
	// Nodes - READ-ONLY; The collection of returned AmlCompute nodes details.
	Nodes *[]AmlComputeNodeInformation `json:"nodes,omitempty"`
}

// MarshalJSON is the custom marshaler for AmlComputeNodesResult.
func (acnr AmlComputeNodesResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	return json.Marshal(objectMap)
}
...
type ComputeNodesInformation struct {
	// NextLink - READ-ONLY; The continuation token.
	NextLink *string `json:"nextLink,omitempty"`
	// ComputeType - Possible values include: 'ComputeTypeComputeNodesInformation'
...
func (cni ComputeNodesInformation) MarshalJSON() ([]byte, error) {
	cni.ComputeType = ComputeTypeComputeNodesInformation
	objectMap := make(map[string]interface{})
	if cni.ComputeType != "" {
...
// DiagnoseRequestProperties properties of a diagnose request
type DiagnoseRequestProperties struct {
	// Udr - Setting for diagnosing user defined routing
	Udr interface{} `json:"udr,omitempty"`
	// Nsg - Setting for diagnosing network security group
	Nsg interface{} `json:"nsg,omitempty"`
	// ResourceLock - Setting for diagnosing resource lock
	ResourceLock interface{} `json:"resourceLock,omitempty"`
	// DNSResolution - Setting for diagnosing dns resolution
	DNSResolution interface{} `json:"dnsResolution,omitempty"`
	// StorageAccount - Setting for diagnosing dependent storage account
	StorageAccount interface{} `json:"storageAccount,omitempty"`
	// KeyVault - Setting for diagnosing dependent key vault
	KeyVault interface{} `json:"keyVault,omitempty"`
	// ContainerRegistry - Setting for diagnosing dependent container registry
	ContainerRegistry interface{} `json:"containerRegistry,omitempty"`
	// Others - Setting for diagnosing unclassified category of problems
	Others interface{} `json:"others,omitempty"`
}

// DiagnoseResponseResult result of DiagnoseResponse
type DiagnoseResponseResult struct {
	autorest.Response `json:"-"`
	// Value - Value of DiagnoseResponse
	Value *DiagnoseResponseResultValue `json:"value,omitempty"`
}

// DiagnoseResponseResultValue value of DiagnoseResponse
type DiagnoseResponseResultValue struct {
	// UDR - UDR value
	UDR *[]DiagnoseResult `json:"UDR,omitempty"`
	// NSG - NSG value
	NSG *[]DiagnoseResult `json:"NSG,omitempty"`
	// ResourceLock - Resource Lock
	ResourceLock *[]DiagnoseResult `json:"ResourceLock,omitempty"`
	// DNSResolution - DNS Resolution
	DNSResolution *[]DiagnoseResult `json:"DNSResolution,omitempty"`
	// StorageAccount - Storage Account
	StorageAccount *[]DiagnoseResult `json:"StorageAccount,omitempty"`
	// KeyVault - The KeyVault
	KeyVault *[]DiagnoseResult `json:"KeyVault,omitempty"`
	// ContainerRegistry - Container Registry
	ContainerRegistry *[]DiagnoseResult `json:"ContainerRegistry,omitempty"`
	// Others - Other items
	Others *[]DiagnoseResult `json:"Others,omitempty"`
}
...
type DiagnoseResult struct {
	...
	// Level - READ-ONLY; Level of workspace setup error. Possible values include: 'Warning', 'Error'
...
// SynapseAKSProperties AKS properties
type SynapseAKSProperties struct {
	// AutoScaleProperties - Auto scale properties.
...
type SynapseSpark struct {
	...
	DisableLocalAuth *bool `json:"disableLocalAuth,omitempty"`
	// Properties - AKS Properties
	Properties *SynapseAKSProperties `json:"properties,omitempty"`
}
...
type WorkspaceProperties struct {
	...
	TenantID *string `json:"tenantId,omitempty"`
	// StorageHnsEnabled - READ-ONLY; If the storage associated with the workspace has HNS enabled.
	StorageHnsEnabled *string `json:"storageHnsEnabled,omitempty"`

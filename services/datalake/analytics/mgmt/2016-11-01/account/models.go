...
type DataLakeAnalyticsAccountProperties struct {
	...
	// HierarchicalQueue - READ-ONLY; The hierarchical queue associated with this account.
	HierarchicalQueue *DataLakeAnalyticsAccountPropertiesHierarchicalQueue `json:"hierarchicalQueue,omitempty"`
...
// DataLakeAnalyticsAccountPropertiesHierarchicalQueue the hierarchical queue associated with this account.
type DataLakeAnalyticsAccountPropertiesHierarchicalQueue struct {

...
type EntityAnalytics struct {
	...
	*EntityAnalyticsProperties `json:"properties,omitempty"`
	...
	// Etag - Etag of the azure resource
	Etag *string `json:"etag,omitempty"`
	// Kind - Possible values include: 'KindBasicSettingsKindSettings', 'KindBasicSettingsKindUeba', 'KindBasicSettingsKindEntityAnalytics', 'KindBasicSettingsKindEyesOn', 'KindBasicSettingsKindIPSyncer'

...
func (client GetPrivateDNSZoneSuffixClient) Execute(ctx context.Context, subscriptionID string, body string) (result String, err error) {
	...
	if err := validation.Validate([]validation.Validation{
		...
		return result, validation.NewError("mysqlflexibleservers.GetPrivateDNSZoneSuffixClient", "Execute", err.Error())
	}

	req, err := client.ExecutePreparer(ctx, subscriptionID, body)
	if err != nil {
...
func (client GetPrivateDNSZoneSuffixClient) ExecutePreparer(ctx context.Context, subscriptionID string, body string) (*http.Request, error) {
	const APIVersion = "2020-07-01-preview"
	queryParameters := map[string]interface{}{
		"api-version":    APIVersion,
		"subscriptionId": autorest.Encode("query", subscriptionID),
	}

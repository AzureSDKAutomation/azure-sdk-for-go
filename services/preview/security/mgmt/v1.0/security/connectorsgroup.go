...
func NewConnectorsGroupClient(subscriptionID string, ascLocation string) ConnectorsGroupClient {
	return NewConnectorsGroupClientWithBaseURI(DefaultBaseURI, subscriptionID, ascLocation)
}
...
func NewConnectorsGroupClientWithBaseURI(baseURI string, subscriptionID string, ascLocation string) ConnectorsGroupClient {
	return ConnectorsGroupClient{NewWithBaseURI(baseURI, subscriptionID, ascLocation)}
}

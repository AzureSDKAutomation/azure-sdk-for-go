...
// ResourceWithEtagV1 an azure resource object with an Etag property
type ResourceWithEtagV1 struct {
	// ID - READ-ONLY; Azure resource Id
	ID *string `json:"id,omitempty"`
	// Name - READ-ONLY; Azure resource name
	Name *string `json:"name,omitempty"`
...
// MarshalJSON is the custom marshaler for ResourceWithEtagV1.
func (rwev ResourceWithEtagV1) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	if rwev.Etag != nil {
		objectMap["etag"] = rwev.Etag
	}
	return json.Marshal(objectMap)
}

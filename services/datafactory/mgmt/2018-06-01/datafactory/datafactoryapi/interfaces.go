...
type IntegrationRuntimesClientAPI interface {
	...
	OutboundNetworkDependenciesEndpoints(ctx context.Context, resourceGroupName string, factoryName string, integrationRuntimeName string) (result datafactory.IntegrationRuntimeOutboundNetworkDependenciesEndpointsResponse, err error)

...
type IntegrationRuntimesClientAPI interface {
	...
	OutboundNetworkDependenciesEndpoints(ctx context.Context, resourceGroupName string, workspaceName string, integrationRuntimeName string) (result synapse.IntegrationRuntimeOutboundNetworkDependenciesEndpointsResponse, err error)
